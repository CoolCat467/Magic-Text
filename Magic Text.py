        ...
        while True:
            ...
            if not mode-2 > 0: # modes 1 and 2
                ...
                if not bool(mode-5):#mode 5
                    ...
                    printz('Total Words      : '+str(len(lookup)))
                    printz('Space Avalable   : '+str(int(9999-len(lookup))))
                    printz('Space Used       : '+str(len(lookup))+' / 9999')
                    printz('Usage Percentage : '+str(int(maths.findpercent(len(lookup), 9999)))+'%')
